...
>[!ALERT] Alert
>Use this fork of PXETHeif, it fixes hash extraction & decryption issues: https://github.com/blurbdust/PXEThief

> [!NOTE] Note
>  PXEThief  should only be used on windows due to the pywin32 dependency, it also works best with python 3.10 (Unless you're using the blurbdust fork)
...
Try a blank password for a quick win.

```bash
python pxethief.py 3 '.\\<...>.boot.var' ''
```
